...
kubectl set image deployments/client-deployment client=davidwei01/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=davidwei01/multi-worker:$SHA